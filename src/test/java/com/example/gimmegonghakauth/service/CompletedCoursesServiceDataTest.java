...
@ActiveProfiles("test")
class CompletedCoursesServiceDataTest {
    ...
    void setCourses() {
        ...
        coursesDao.save(courseDomain1);
        coursesDao.save(courseDomain2);
    }
    ...
    void testUploadFile() {
        ...
        CompletedCoursesDomain data1 =
            CompletedCoursesDomain.builder().
                                  ...
                                  courseDomain(coursesDao.findByCourseId(12345L)).
        ...
        CompletedCoursesDomain data2 =
            CompletedCoursesDomain.builder().
                                  userDomain(userRepository.findByStudentId(19111111L).get()).
                                  courseDomain(coursesDao.findByCourseId(54321L)).
                                  year(23).semester("1학기").
                                  build();
